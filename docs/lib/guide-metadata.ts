...
const GUIDE_METADATA = {
  ...
  [GUIDE_PATHS.heyApiTypedStruct]: {
    ...
    image: '/iskit_guide5.gif',
    imageAlt: 'Validate Hey API generated TypeScript types with typedStruct'
  },
