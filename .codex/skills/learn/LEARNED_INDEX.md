...
- **[require-singleton-keys-for-single-property-refinements](learned/require-singleton-keys-for-single-property-refinements.md)** - Restrict one-property predicates to singleton literal keys so one runtime lookup cannot narrow a union or broad key set.
