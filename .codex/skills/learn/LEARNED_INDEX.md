...
- **[require-singleton-keys-for-single-property-refinements](learned/require-singleton-keys-for-single-property-refinements.md)** - Reject unions, broad keys, and infinite template patterns when one runtime lookup narrows one property.
